                    ...
                    <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-1 mb-3">
                        <div class="card h-100 text-center calendar-card {{ $month['total'] > 0 ? 'has-link' : '' }} {{ $month['total'] === 0 ? 'opacity-50 pe-none' : '' }}">
                            <div class="card-body p-2">
                                ...
                                @if($month['total'] > 0)
                                    <a href="https://github.com/magento/magento2/issues?q=is%3Aissue%20state%3Aopen%20updated%3A{{$month['start']}}..{{$month['end']}}" target="magentoForgerGitHub" class="stretched-link">
